...
type TMFCNDate = Cardinal;

function DecodeGregToCNDate(dtGreg:TDateTime):TMFCNDate;
...
function IsCNLeap(CnDate:TMFCNDate):boolean;
function CNFormatDateTime(const Format: string; DateTime: TDateTime):string;
implementation
